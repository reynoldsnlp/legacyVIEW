view.cookies = {
	...
	getCookie: function(doc, c_name) {
		alert("getCookie(doc, c_name");
		alert("doc: " + JSON.stringify(doc));
		alert("c_name" + JSON.stringify(c_name));
	...
	setCookie: function(doc, c_name, value, exhours, path) {
		alert("setCookie(doc, c_name, value, exhours, path");
		alert("doc: " + JSON.stringify(doc));
		alert("c_name" + JSON.stringify(c_name));
		alert("value" + JSON.stringify(value));
		alert("exhours" + JSON.stringify(exhours));
	...
	deleteCookie: function(doc, c_name, path) {
		alert("deleteCookie(doc, c_name, path");
		alert("doc: " + JSON.stringify(doc));
		alert("c_name" + JSON.stringify(c_name));
		alert("path" + JSON.stringify(path));
	...
	areCookiesEnabled: function(doc, path) {
		alert("areCookiesEnabled(doc, path");
		alert("doc: " + JSON.stringify(doc));
		alert("path" + JSON.stringify(path));
