...
public class RelevantText_Type extends Annotation_Type {
  ...
  public void setHtmlContentType(int addr, String v) {
        if (featOkTst && casFeat_htmlContentType == null)
      jcas.throwFeatMissing("htmlContentType", "werti.uima.types.annot.RelevantText");
    ll_cas.ll_setStringValue(addr, casFeatCode_htmlContentType, v);}
  ...
  public RelevantText_Type(JCas jcas, Type casType) {
    ...
    casFeat_htmlContentType = jcas.getRequiredFeatureDE(casType, "htmlContentType", "uima.cas.String", featOkTst);
    casFeatCode_htmlContentType  = (null == casFeat_htmlContentType) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_htmlContentType).getCode();
